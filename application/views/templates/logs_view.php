                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed" id="log-table">
                                            ...
                                            <?php foreach ($all_events as $ek => $ev): ?>
                                                ...
                                                <td class="text-left"> <?php if ($ev['type'] == 0): ?><i class="fa fa-cube"></i>&nbsp;project<?php endif ?>  <?php if ($ev['type'] == 1 OR $ev['type'] == 3 OR $ev['type'] == 4): ?><i class="fa fa-gavel"></i>&nbsp;Task<?php endif ?> <?php if ( $ev['type'] == 5): ?><i class="fa fa-pencil"></i>&nbsp;Task<?php endif ?></td>
