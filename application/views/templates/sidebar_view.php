  ...
  <div id="sidebar-wrapper">
    ...
    <ul class="sidebar-nav">
      ...
      <li class="<? $url_arg=='clients' ? print('active') : print('') ?>"><a href="<?php print(base_url());?>clients"><span class="icon-client"></span>&nbsp;<span class="left-resp-menu"><?php print(lang('menu_clients')); ?></span></a>
        <?php endif ?>
      <li class="<? $url_arg=='projects' ? print('active') : print('') ?>"><a href="<?php print(base_url());?>projects"><span class="icon-projects"></span>&nbsp;<span class="left-resp-menu"><?php print(lang('menu_projects')); ?></span></a>
      ...
      <li class="<? $url_arg=='tasks' ? print('active') : print('') ?>"><a href="<?php print(base_url());?>tasks"><span class="icon-tasks"></span>&nbsp;<span class="left-resp-menu"><?php print(lang('menu_tasks')); ?></span></a>
