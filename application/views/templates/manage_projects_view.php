...
<span class="label label-default label-tag" style="cursor: default"><i class="fa fa-mail"></i>&nbsp;<span class="get_old_mail"><?php print(short_name($user_name[$av['uid']])); ?>&nbsp;(<?php print(show_role_abbr($users_title_roles[$av['uid']])); ?>)&nbsp;<i class="fa fa-times unsign-user" data-project="<?php print($pv['pid']); ?>" data-uid="<?php print($av['uid']); ?>"></i></span>
                            &nbsp;&nbsp;&nbsp;</span>
                                            <?php endif ?>
                                        <?php endforeach ?>
                                    </span>
