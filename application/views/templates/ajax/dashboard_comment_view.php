<?php if ($to[0]['id'] == $user->id): ?>
    <div class="sub-activity">
        <div class="activity-item-summary">
            ...
            <a href="javascript:void(0);" class="activity-item-user activity-item-author qm-send-comment" target="_parent" data-uid="<?php print($cv[0]['uid']); ?>"> <?php print(short_name($user_name[$cv[0]['uid']])); ?></a>&nbsp;<span class="label label-warning label-xs">subject</span>&nbsp; <a href="javascript:void(0);" class="send-comment-subject" target="_parent"  data-uid="<?php print($cv[0]['uid']); ?>"  data-title="<?php print($cv[0]['subject']); ?>"><span class="resolved-link"><?php print($cv[0]['subject']); ?></span></a>
            ...
            <div class="activity-item-description">
                ...
                <div class="activity-item-info">
                    ...
                    <span class="activity-item-action"><a href="javascript:void(0);" class="activity-item-comment-link qm-send-comment" data-uid="<?php print($cv[0]['uid']); ?>" >Comment</a></span>
                </div>
            </div>
        </div>
    </div>
